...
public class ProjectActivity6 {
 ...
 // Test method
    ...
    public void popupsPage() {
    	...
    	Point end = new Point((int) (dims.getWidth() * .50), (int) (dims.getHeight() * .25));
        ...
        Point tap = new Point((int) (dims.getWidth() * .25), (int) (dims.getHeight() * .25));
        ActionsBase.doTap(driver,tap);        
